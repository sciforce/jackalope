...
def jackalope_hash_id(string_to_hash: str, key: Optional[bytes] = HASH_COMPATIBILITY_VERSION) -> int:
...
def jackalope_hash_code(string_to_hash: str, key: Optional[bytes] = HASH_COMPATIBILITY_VERSION) -> str:
